...
{
	/**
	 * @see org.joox.environment.Environment#init()
	 */
	@Override
	@SuppressWarnings("nls")
	protected void init()
	{
		configurationProperty = "org.joox.configuration.PropertyConfiguration2#" + getClasspath();
		environmentProperty = "org.joox.environment.DefaultEnvironment";
	}
